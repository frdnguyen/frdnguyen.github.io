...
![](_images/intro_homer.png "Homer vu à travers une imagerie médicale. Image reproduite sur de nombreux sites.")
{% include image.html url="/_images/intro_homer.png" description="Homer vu à travers une imagerie médicale. Image reproduite sur de nombreux sites." %}
