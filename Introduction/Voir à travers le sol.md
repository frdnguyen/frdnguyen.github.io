...
#![Homer vu à travers une imagerie médicale. Image reproduite sur de nombreux sites.](../assets/images/intro_homer.png)

<img src="../assets/images/intro_homer.png" style="display:block;float:none;margin-left:auto;margin-right:auto;width:60%"> 
